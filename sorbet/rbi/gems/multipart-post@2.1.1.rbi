...
class CompositeReadIO
  ...
  #
  # source://multipart-post//lib/composite_io.rb#18
  def initialize(*ios); end

  # Read from IOs in order until `length` bytes have been received.
  #
  # source://multipart-post//lib/composite_io.rb#24
  def read(length = T.unsafe(nil), outbuf = T.unsafe(nil)); end

  # source://multipart-post//lib/composite_io.rb#41
  def rewind; end

  private

  # source://multipart-post//lib/composite_io.rb#52
  def advance_io; end

  # source://multipart-post//lib/composite_io.rb#48
  def current_io; end
end
...
class Parts::EpiloguePart
  ...
  #
  # source://multipart-post//lib/parts.rb#121
...
class Parts::FilePart
  ...
  #
  # source://multipart-post//lib/parts.rb#72
...
class Parts::ParamPart
  ...
  #
  # source://multipart-post//lib/parts.rb#39
  ...
  # @param headers [Hash] Content-Type is used, if present.
  #
  # source://multipart-post//lib/parts.rb#52
  def build_part(boundary, name, value, headers = T.unsafe(nil)); end

  # source://multipart-post//lib/parts.rb#44
  def length; end
end

module Parts::Part
  # source://multipart-post//lib/parts.rb#22
  def length; end

  # source://multipart-post//lib/parts.rb#26
  def to_io; end

  class << self
    # @return [Boolean]
    #
    # source://multipart-post//lib/parts.rb#18
    def file?(value); end

    # source://multipart-post//lib/parts.rb#9
...
class UploadIO
  ...
  # source://multipart-post//lib/composite_io.rb#101
  ...
  # @return [Boolean]
  #
  # source://multipart-post//lib/composite_io.rb#105
  def respond_to?(meth, include_all = T.unsafe(nil)); end

  class << self
    # @raise [ArgumentError]
    #
    # source://multipart-post//lib/composite_io.rb#95
