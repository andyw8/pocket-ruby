...
module Parallel
  ...
  class << self
    ...
    # source://parallel//lib/parallel.rb#301
    ...
    # source://parallel//lib/parallel.rb#297
    def map_with_index(array, options = T.unsafe(nil), &block); end

    # source://parallel//lib/parallel.rb#305
    ...
    # source://parallel//lib/parallel.rb#512
    def call_with_index(item, index, options, &block); end

    # source://parallel//lib/parallel.rb#444
    def create_workers(job_factory, options, &block); end

    # options is either a Integer or a Hash with :count
    #
    # source://parallel//lib/parallel.rb#502
    def extract_count_from_options(options); end

    # source://parallel//lib/parallel.rb#478
    def process_incoming_jobs(read, write, job_factory, options, &block); end

    # source://parallel//lib/parallel.rb#432
    def replace_worker(job_factory, workers, index, options, blk); end

    # source://parallel//lib/parallel.rb#523
    def with_instrumentation(item, index, options); end

    # source://parallel//lib/parallel.rb#341
    def work_direct(job_factory, options, &block); end

    # source://parallel//lib/parallel.rb#385
    def work_in_processes(job_factory, options, &blk); end

    # source://parallel//lib/parallel.rb#360
    def work_in_threads(job_factory, options, &block); end

    # source://parallel//lib/parallel.rb#452
...
module Parallel::ProcessorCount
  ...
  #
  # source://parallel//lib/parallel/processor_count.rb#13
  def physical_processor_count; end

  # Number of processors seen by the OS, used for process scheduling
  #
  # source://parallel//lib/parallel/processor_count.rb#8
